...
exports.publish = function(taffyData, opts, tutorials) {
  ...
  // @TODO this is the entry point...I think...
  ...
  if (packageInfo && packageInfo.name) {
    // Remove package name from outdir (?)
  ...
  view.version = (packages && packages[0].version) || false
  view.basePath = (view.version && `/${view.version}/`) || '/'
  ...
  generate(
    ...
    // @TODO parse the files in the order I want them and set headers above them
    // Hiding files for now...
    // .concat(files),
    indexUrl
  )
